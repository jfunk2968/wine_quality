...
best_cv1_iter <- xgb_m1_cv1$best_iteration
```
...
for(depth in c(7,8,9,10,11,12))  {
  ...
  print(paste(as.character(depth), " : ", as.character(max(cv$evaluation_log$test_auc_mean)), sep=""))
}
```
...
for(sample in c(.6,.7,.8,.9))  {
  ...
  print(paste(as.character(sample), " : ", as.character(max(cv$evaluation_log$test_auc_mean)), sep=""))
}
```
...
for(colsample in c(.85,.9,.95,1))  {
  ...
  print(paste(as.character(colsample), " : ", as.character(max(cv$evaluation_log$test_auc_mean)), sep=""))
}
```

Best column sample rate is .9
...
for(gam in c(0, 3, 6, 10))  {
  ...
  print(paste(as.character(gam), " : ", as.character(max(cv$evaluation_log$test_auc_mean)), sep=""))
}
```
